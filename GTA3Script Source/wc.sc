...
throw_char_velocity:
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS iObj 0.0 25.0 15.0 (x[0] y[0] z[0])
...
task_attach_to:
    ...
    IF DOES_CHAR_EXIST iChar
        ...
        //TASK_PLAY_ANIM_NON_INTERRUPTABLE iChar ("ko_wall" "spider") 26.0 (0 1 1 1) -2
        WAIT 0
...
show_fx:
    IF DOES_CHAR_EXIST iChar
    AND NOT IS_CHAR_DEAD iChar
        CREATE_FX_SYSTEM_ON_CHAR SP_HIT_WEB iChar (0.0 0.25 0.5) 4 (fx_web)
        PLAY_AND_KILL_FX_SYSTEM fx_web
    ENDIF
RETURN
